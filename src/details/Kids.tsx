...
const KidsProgramingSchool: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="CommonDetails__container">
        ...
        <h2 className="CommonDetails__title">KidsProgramingSchool</h2>
        <p className="CommonDetails__sub">- KidsProgramingSchool -</p>
...
export default KidsProgramingSchool;
